        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialNumber = table.Column<string>(type: "nvarchar(300)", nullable: true),
                    Specifications = table.Column<string>(type: "nvarchar(4000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GoogleScholarUrl = table.Column<string>(type: "nvarchar(4000)", nullable: true),
                    AcademiaUrl = table.Column<string>(type: "nvarchar(4000)", nullable: true),
                    ScopusUrl = table.Column<string>(type: "nvarchar(4000)", nullable: true),
                    ResearcherGateUrl = table.Column<string>(type: "nvarchar(4000)", nullable: true),
                    ExpertiseArea = table.Column<string>(type: "nvarchar(50)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOnOverNight = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Labs_AspNetUsers_SupervisiorId",
